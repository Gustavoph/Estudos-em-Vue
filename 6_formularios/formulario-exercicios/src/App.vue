		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Mensagem">
					<textarea name="" cols="30" rows="5" v-model.lazy="mensagem"></textarea>
				</Rotulo>
				<Rotulo nome="Características do Problema">
					<span class="mr-4"><input type="checkbox" v-model="características"
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Marque as Opções">
					<span >
						<ul>
							<li v-for="carac in características" :key="carac">{{ carac }}</li>
						</ul>
					</span>
				</Rotulo>
				<Rotulo nome="Qual produto?">
